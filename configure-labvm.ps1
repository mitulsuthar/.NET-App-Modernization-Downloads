...
Invoke-WebRequest 'https://github.com/microsoft/.NET-Modernization-In-a-Day/archive/refs/heads/master.zip' -OutFile 'C:\mod.zip'
Expand-Archive -LiteralPath 'C:\mod.zip' -DestinationPath 'C:\mod' -Force
