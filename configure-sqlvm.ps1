...
Invoke-WebRequest 'https://github.com/microsoft/.NET-Modernization-In-a-Day/raw/master/Hands-on%20lab/lab-files/Database/ContosoInsurance.zip' -OutFile 'C:\ContosoInsurance.zip'
